...
git clone -b development git@github.com:twidpay-global/twid_system.git /twid/deploy/system_unit_test

cp -Rv /twid/deploy/system_unit_test/* /twid/system_unit_test

#cp /twid/config/env.system.dev /twid/system_unit_test/.env

cp /twid/config/env.system.dev.tmp-2 /twid/system_unit_test/.env
