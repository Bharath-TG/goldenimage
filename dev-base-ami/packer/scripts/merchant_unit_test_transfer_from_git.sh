...
git clone -b development git@github.com:twidpay-global/twid_merchant.git /twid/deploy/merchant_unit_test

cp -Rv /twid/deploy/merchant/* /twid/merchant_unit_test


# cp /twid/merchant_unit_test/.env_bkup /twid/merchant_unit_test/.env
cp /twid/config/env.merchant.dev.tmp-2 /twid/merchant_unit_test/.env
