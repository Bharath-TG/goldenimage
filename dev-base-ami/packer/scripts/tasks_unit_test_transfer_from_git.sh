...
git clone -b development git@github.com:twidpay-global/twid_tasks.git /twid/deploy/tasks_unit_test
...
# cp /twid/config/env.merchant.dev /twid/tasks_unit_test/.env
cp /twid/config/env.merchant.dev.tmp-2 /twid/tasks_unit_test/.env
